...
public class Controller {
    ...
    public static void main(String[] args) {
        ...
        for(int n = 1; n<=35; n++){
            ...
            for(int i=1; i<=n; i++){
                ...
                int counter = 0;
                 ...
                 while(stackIterator.hasNext()){
                   //YOU NEED SOME CODE HERE
                   if (stackIterator.next().equals("fib("+i+")")){
                   counter++;
                   }
            ...
            executionInfo = new ExecutionInfo(map, n, fibValue,chrono.getElapsedTime());
           
            
            
            // add the executionInfo object to the dataAnalyzer arraylist
            // YOUR CODE HERE
            dataAnalizer.getData().add(executionInfo);
        ...
        // YOUR CODE HERE
         for (ExecutionInfo exInfo : dataAnalizer.getData()){   
            exInfo.displayInfo();
        }
